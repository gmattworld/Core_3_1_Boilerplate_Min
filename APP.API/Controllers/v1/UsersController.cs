...
namespace APP.API.Controllers.v1
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        /// URI:
        /// 
        ///     Get /api/v1.0/Users/b41229e2-370d-4aa2-a6fc-7ded5926d4d0
        /// 
        /// </remarks>
        /// <param name="ID"></param>
        /// <returns code="200"></returns>
        ...
        public async Task<ActionResult<DataResponse<CountryExtModel>>> GetByID([FromRoute] string ID)
        {
            ...
            try
            {
                var _country = await _unitOfWork.Users.GetAsync(ID).ConfigureAwait(false);
                if (_country == null)
                {
        ...
        [ProducesResponseType(typeof(DataResponse<CountryExtModel>), StatusCodes.Status400BadRequest)]
        [ProducesDefaultResponseType]
        public async Task<ActionResult<DataResponse<CountryExtModel>>> Post([FromBody] CategoryMiniModel model)
        {
            DataResponse<CountryExtModel> response = new DataResponse<CountryExtModel>();
            CountryExtModel _DTO = null;
            ...
            try
            {
                if (ModelState.IsValid && model != null)
                {
                    ...
                    // Check Entity Exist
                    if (_unitOfWork.Users.CheckExist(model.Name, model.Code, out errorMsg))
                    {
                        response.Code = ResponseCode.FAILED;
                        response.Description = ResponseDescription.FAILED;
                        response.Message = errorMsg;
                    ...
                    // Create user
                    var _country = await _unitOfWork.Users.InsertAsync(_entity).ConfigureAwait(false);
        ...
        /// URI:
        /// 
        ///     Post /api/v1.0/Users/b41229e2-370d-4aa2-a6fc-7ded5926d4d0
        /// 
        /// Payload:
        /// 
        ///     {
        ...
        /// URI:
        /// 
        ///     Post /api/v1.0/Users/b41229e2-370d-4aa2-a6fc-7ded5926d4d0/Restriction
        /// 
        /// Payload:
        /// 
        ///     {}
        ...
        public async Task<ActionResult<DataResponse<CountryExtModel>>> Patch([FromRoute] string ID)
        {
            ...
            try
            {
                ...
                {
                    // Update country
                    var _country = await _unitOfWork.Users.UpdateCountryRestrictions(ID).ConfigureAwait(false);
                    if (_country == null)
                    {
                        response.Code = ResponseCode.FAILED;
                        response.Description = ResponseDescription.FAILED;
        ...
        /// URI:
        /// 
        ///     Delete /api/v1.0/Users/b41229e2-370d-4aa2-a6fc-7ded5926d4d0
        /// 
        /// </remarks>
        /// <param name="ID"></param>
        ...
        public async Task<ActionResult<DataResponse<CountryExtModel>>> Delete([FromRoute] string ID)
        {
            ...
            try
            {
                ...
                {
                    // Update country
                    var _country = await _unitOfWork.Users.DeleteCountry(ID).ConfigureAwait(false);
                    if (_country == null)
                    {
                        response.Code = ResponseCode.FAILED;
                        response.Description = ResponseDescription.FAILED;
